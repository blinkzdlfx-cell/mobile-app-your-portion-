...
class BecomeTrustedMemberScreen extends StatefulWidget {
  const BecomeTrustedMemberScreen({super.key});

  @override
  State<BecomeTrustedMemberScreen> createState() => _BecomeTrustedMemberScreenState();
}

class _BecomeTrustedMemberScreenState extends State<BecomeTrustedMemberScreen> {
  ...
  Future<void> _checkPending() async {
    final existing = await _supabaseService.getPendingRequest('trusted_member');
          ...
          child: Column(
            children: [
              ...
              Row(
                children: [
                  ...
                  Container(
                    ...
                    child: const Icon(Icons.eco_outlined, color: AppTheme.primary, size: 28),
                  ),
                  const Spacer(),
              ...
              if (_hasPendingRequest) ...[
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text('Your trusted member verification request is being reviewed by an admin. You\'ll be notified once it\'s approved.',
                ...
                Text('Become a Trusted Member',
                  style: Theme.of(context).textTheme.headlineLarge?.copyWith(
                    color: AppTheme.onBackground, fontSize: 28),
                  textAlign: TextAlign.center),
                const SizedBox(height: 12),
                Text('Trusted Members help create a safer and more reliable community for everyone.',
                ...
                const SizedBox(height: 12),
                _InputField(label: 'Why do you want to be a Trusted Member?', controller: _reasonController, hint: 'Tell us a bit about yourself...', maxLines: 4),
                const SizedBox(height: 24),
                SizedBox(
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Expanded(child: Text(
                        'Your information is securely protected and is only used to maintain a trusted community.',
